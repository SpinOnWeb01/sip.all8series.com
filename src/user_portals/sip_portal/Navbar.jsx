...
const tabConfig = {
  ...
  active_calls: {
    label: "LIVE CALLS",
    icon: <Call style={{ color: "#f5751D", fontSize: "20px !important" }} />,
  },
  audit_logs: {
    label: "AUDIT LOGS",
    icon: (
...
function Navbar() {
  ...
  const filteredTabs = ["dashboard", "did_tfn_number", "extensions", "report"]; //  Add other tabs here

  return (
    <>
      <Box sx={{ width: "100%", backgroundColor: "#0e397f" }} className="sip_tabs">
