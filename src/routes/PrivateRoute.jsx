...
function PrivateRoute() {
  ...
  if (callactive !== undefined) {
    ...
    return filteredData.sort((a, b) => dayjs(b.TimeStamp) - dayjs(a.TimeStamp));
  }
  return [];
        ...
        {user !== null ? (
          <>
            <Route
              ...
              element={
                <AdminLayout colorThem={colorThem} handleClick={handleClick} mockDataTeam={mockDataTeam}/>
              }
            >
              <Route
                path={Router.ADMIN_DASHBOARD}
              ...
              <Route
                ...
                element={<Suspense fallback={<div style={{display:"flex", justifyContent:"center",alignItems: "center",
                  height: "100vh",
                  textAlign: "center", backgroundColor:"#f7efe5"}}>Loading...</div>}><AdminReport colorThem={colorThem} /></Suspense>}
              />
              <Route
              ...
              <Route
                ...
                element={<AdminCallActive colorThem={colorThem}  radioValue={radioValue}
